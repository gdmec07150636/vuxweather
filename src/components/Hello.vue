<template>
  <div>
    ...
    <group>
      <x-address title="请选择城市" v-model="citypost" :list="addressData" hide-district @on-hide="getWheather"></x-address>
    </group>
    ...
    <x-button type="primary" @click.native="getWheather">查询天气</x-button>
